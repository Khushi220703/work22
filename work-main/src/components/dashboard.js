...
const submit = async () =>
  { 
   ...
   const res = await axios.put("https://work22-tau.vercel.app/signup",{userNames,locations})
  ...
  console.log(image);
   try {
     ...
     const res = await axios.put(`https://work22-tau.vercel.app/signup__`,formData,{
